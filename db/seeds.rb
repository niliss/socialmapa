...
50.times do
	...
	counter += 1
	2.times do
	Event.create(name: Faker::Company.name, description: Faker::Lorem.words(500), initial_date: start_date, end_date: end_date, event_type: "false", institution_id: counter, latitude: rand(6.209238..6.459238), longitude: rand(-75.655555..-75.455555))
	end
end